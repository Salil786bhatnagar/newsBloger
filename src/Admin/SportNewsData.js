...
export default function SportNewsData() {
    ...
    const handleClick=async(e)=>{
        ...
        var formData = new FormData();
             ...
             var result = await postDataAndImage('sport/sportsNews',formData,config)
             console.log(result); 
             if(result){
  ...
  return (
    <div>
       <b><u><span>Sport News Data</span></u></b>
       <br/><hr/>
           ...
           <Grid item xs={12} sm={6}>
            ...
            <Grid item xs={12} sm={6}>
                ...
                <label htmlFor="contained-button-file">
                  ...
                  <span className="span_reset-sport">
